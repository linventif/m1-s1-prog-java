    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(new FileInputStream(PATH_DATA + fichier))) {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (!ch.isEmpty()) {
                    int me = (int) ch.charAt(2) - 87; // X=1, Y=2, Z=3
                    int opponent = (int) ch.charAt(0) - 64; // A=1, B=2, C=3 (Rock, Paper, Scissors)
        ...
        System.out.println("Total score part 2: " + totalScorePart2);
    }
}
